...
namespace MoreTypes_Lib
{
    public class ArraysExercises
    {
        ...
        //    if (length1*length2*length3 == contents.Count)
        //    {
        //        string[,,] stringArray = new string[length1, length2, length3];
        //        stringArray[0, 0, 0] = "Alpha";
        //        stringArray[0, 0, 1] = "Beta";
        //        stringArray[0, 0, 2] = "Gamma";
        //        stringArray[1, 0, 0] = "Delta";
        //        stringArray[1, 0, 1] = "Epsilon";
        //        stringArray[1, 0, 2] = "Zeta";
        //        return stringArray;
